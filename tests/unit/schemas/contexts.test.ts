...
import { SchemaManager, ContextManager  } from "../../../src/services/common";
import { HelperUtils } from "../../../src/utils";

describe('context utilities', () => {
    it('Successfully loads credentialsContxt', async () => {
        const result = await ContextManager.getCreds();
        console.log(result);
        expect(result).toBeDefined()
    })

    it('Successfully loads creds context', async () => {
        const result = await ContextManager.getCredsContext();
        console.log(result);
        expect(result).toBeDefined()
    })

    it('Successfully loads creds contextMap', async () => {
        const result = await ContextManager.getCredsContextMap();
        //console.log(result);
       // expect(result).toBeDefined()
    })

    it('Successfully loads cjsonld', async () => {
        const result = await ContextManager.getJSONLD();
        console.log(result);
        expect(result).toBeDefined()
    })

    it('Successfully loads jsonld doc loader', async () => {
        const result = await ContextManager.getJSONLDdocLoader();
       // console.log(result);
       // expect(result).toBeDefined()
    })

    /*
    it('Successfully loads jsonld-signatures', async () => {
        const result = await ContextManager.getJSONLDsignatures();
        console.log(result);
        expect(result).toBeDefined()
    })
    */
